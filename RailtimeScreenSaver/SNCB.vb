...
Public Class SNCB
    ...
    Public Const FILTER_TRAM As Long = 32
    Public Const FILTER_BUS As Long = 64
    Public Const FILTER_METRO As Long = 128
    Public Const FILTER_L As Long = 512
    Public Const FILTER_IC As Long = 8192
    Public Const FILTER_INT As Long = 32768
    Public Const FILTER_UNKNOWN As Long = &HFFFF And Not (FILTER_TRAM Or FILTER_BUS Or FILTER_METRO Or FILTER_L Or FILTER_IC Or FILTER_INT)
    ...
    Public Sub New(ByVal Settings As Settings)
        ...
        m_Filter = Settings.GetSetting("sncb", "filter", FILTER_L Or FILTER_IC Or FILTER_INT)
    ...
    Public Overrides Sub SaveSettings(ByVal Settings As Settings)
        ...
        Settings.SaveSetting("sncb", "url", m_Url)
        Settings.SaveSetting("sncb", "lang", m_Language)
        Settings.SaveSetting("sncb", "filter", m_Filter)
    ...
    Public Overrides Function RefreshTrainData(ByVal Time As DateTime) As Boolean
        ...
        Url = Replace(Url, "$filter", BinVal(m_Filter), 1, -1, vbTextCompare)

        '                       1111111111100000
        '                       1111111000000000
        'binnenlandse treinen 1:0111111000000000
        '                       1|||||||||| -> internationale
        '                        ?|||||||||
        '                         1|||||||| -> IC en P treinen
        '                          ?|||||||
        ...
        '
        '
        'alles internationaal   2:1111111111111111
        'bus tram metro trein (niet internationaal) 3:0111111111111111
        'bus tram metro 4:0000000011111111
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.DisplayName("Show L trains")> _
    <System.ComponentModel.Description("Determines if local/slow trains are displayed.")> _
